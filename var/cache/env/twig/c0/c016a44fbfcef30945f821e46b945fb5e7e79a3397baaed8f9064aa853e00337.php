...
class __TwigTemplate_7685aeb7cfa7e04b4b2638cfe7177e64078499ba78574259732d0485458b8032 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <p>On a surement du mal vous renseigner ! Aucun soucis, vous pouvez retourner à l'accueil ou voir nos dernières annonces !</p>
        ...
        echo "\" class=\"btn btn-success\">Nos annonces</a>
    </div>
";
...
{% block title %}Page trouvée{% endblock %}
...
{% block body %}
    <div class=\"container\">
        ...
        <a href=\"{{path('ads_index')}}\" class=\"btn btn-success\">Nos annonces</a>
    </div>
{% endblock %}", "@Twig/Exception/error404.html.twig", "C:\\virtualHost\\liorChamla\\Symfony5\\symbnb\\templates\\bundles\\TwigBundle\\Exception\\error404.html.twig");
    }
}
