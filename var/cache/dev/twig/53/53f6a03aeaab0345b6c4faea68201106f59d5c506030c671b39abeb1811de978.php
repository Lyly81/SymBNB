...
class __TwigTemplate_915cb0eadf0575299fa9f70ee6261bbb65b0c4367aa80a5fc8b7a236116b5666 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 23, $this->source); })()), "data", [], "any", false, false, false, 23));
        ...
        ";
        // line 45
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 45, $this->source); })()), "display", [], "method", false, false, false, 45), "html", null, true);
        echo "
    </div>
...
";
    ...
    {
        return array (  167 => 45,  163 => 43,  151 => 37,  145 => 34,  140 => 32,  135 => 30,  130 => 28,  122 => 27,  118 => 26,  114 => 25,  111 => 24,  107 => 23,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <table class=\"table table-hover\">
            ...
            {% for comment in pagination.data %}
                <tr>
                    ...
                    <td><img src=\"{{comment.author.picture}}\" alt=\"Avatar de {{comment.author.fullName}}\" class=\"avatar avatar-micro\">{{comment.author.fullName}}</td>
...
{% endblock %}
", "admin/comment/index.html.twig", "C:\\virtualHost\\liorChamla\\Symfony5\\symbnb\\templates\\admin\\comment\\index.html.twig");
    }
}
