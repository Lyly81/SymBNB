    ...
    public function getNotAvailableDays() {
        ...
        foreach($this->bookings as $booking) {
            ...
            $resultat = range(
                ...
                24 * 60 * 60 // Le step, c'est le calcul de 24 heures dans une journée.
                // range() renvoie un tableau.
            );

            // array_map() transforme un tableau en un autre tableau qui sera un miroir du tableau.
